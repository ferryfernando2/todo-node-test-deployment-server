...
// Usage:
//   node test_signaling.js --server ws://localhost:8080 --user callerId --target targetUserId --mode incoming
//   node test_signaling.js --server ws://localhost:8080 --user callerId --target targetUserId --mode offer --sdp offer.sdp
...
const server = argv.server || argv.s || 'ws://localhost:8080';
